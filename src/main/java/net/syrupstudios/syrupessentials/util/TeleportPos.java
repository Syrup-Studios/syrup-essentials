...
public class TeleportPos {
    ...
    public TeleportPos(ResourceKey<Level> dimensionId, BlockPos blockPos, float yaw, float pitch, Long time) {
        this.dimensionId = dimensionId;
        this.pos = blockPos;
        this.yaw = yaw;
        this.pitch = pitch;
    ...
    public TeleportPos(Level world, BlockPos p, float pitch, float yaw) {
